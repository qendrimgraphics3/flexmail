...
* Fork and clone [this](https://github.com/qendrimgraphics3) repository to create an instant copy of the code.
...
You can improve it by sending pull requests to [this repository](https://github.com/qendrimgraphics3).
...
### Good First Issues
To help you get your feet wet and get you familiar with our contribution process, we have a list of [good first issues](https://github.com/qendrimgraphics3/labels/good%20first%20issue) that contain bugs which have a relatively limited scope. This is a great place to get started <3.
